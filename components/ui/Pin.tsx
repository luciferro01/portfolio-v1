...
export const PinPerspective = ({
  ...
  return (
    <motion.div className="w-full h-80 flex items-center justify-center opacity-0 group-hover/pin:opacity-100 z-[60] transition duration-500">
      <div className="relative w-full h-full -mt-7 flex items-center justify-center">
        <div className="absolute top-0 inset-x-0 flex justify-center z-[100]">
          <Link
            href={href}
            target="_blank"
            className="relative flex space-x-2 items-center rounded-full bg-zinc-950 py-0.5 px-4 ring-1 ring-white/10 z-[100]"
          >
            <span className="relative w-14 text-center text-white text-xs font-bold inline-block py-0.5">
              {title}
            </span>
